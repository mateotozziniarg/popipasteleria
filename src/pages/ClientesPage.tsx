            ...
            <div key={c.id} className="bg-white border border-[#E5EAF1] rounded-2xl p-4 flex flex-col gap-3">
              ...
              {c.telefono && (
                <div className="flex gap-2 mt-auto">
                  ...
                  <a
                    href={toWhatsAppUrl(c.telefono)}
                    target="_blank"
                    rel="noopener noreferrer"
                    onClick={e => e.stopPropagation()}
                    className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-[#25D366] text-white hover:bg-[#128C7E] transition-colors"
                  >
